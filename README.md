...
│   ├── src/
│   │   ├── components/              # Formularios, Navbar, CardSaldo, etc.
│   │   ├── context/                 # AuthContext
│   │   ├── pages/                   # Home, Registro, Login, Perfil, Creditos
│   │   ├── services/                # api, authService, usuarioService, creditosService
│   │   └── test/                    # setup de Vitest
│   └── .env.example
├── server/                          # Backend Node + Express + Sequelize
│   ├── src/
│   │   ├── config/                  # sequelize.js, database.js
│   │   ├── controllers/             # authController, usuarioController, creditosController
│   │   ├── middleware/              # auth.js (JWT)
│   │   ├── migrations/              # create-usuario, create-transaccion
│   │   ├── models/                  # Usuario, Transaccion
│   │   └── routes/                  # authRoutes, usuarioRoutes, creditosRoutes
│   ├── jest.config.js
│   └── .env.example
├── docs/
├── .gitignore
...
- [x] Frontend del módulo de perfiles (formularios, páginas, rutas y tests).
- [x] Módulo de créditos de tiempo (transferencias atómicas + historial).
- [ ] Módulo de publicaciones / servicios.
